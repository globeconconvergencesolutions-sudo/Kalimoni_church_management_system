-- =============================================================================
-- St. Theresa Parish — Media module setup (safe to re-run)
-- Paste this entire file into Supabase → SQL Editor → Run
--
-- Run ONCE if you have never set up parish_media.
-- Run ONLY the bottom section if parish_media already exists from Sprint 4.
-- =============================================================================

-- ── 1. Base tables (Sprint 4) ───────────────────────────────────────────────
...
drop policy if exists "anon_update_demo_donations" on public.donations;
...
-- ── 2. Media slots columns (site map + gallery separation) ─────────────────
...
-- ── 3. Quick check (should return column names including slot_key, is_slot) ─
