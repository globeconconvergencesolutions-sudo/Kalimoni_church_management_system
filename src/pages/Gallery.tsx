...
const FALLBACK = [
  { id: 'photo-1609234656388-0ff363383899', title: 'Parish Community Gathering', category: 'Church Life', desc: 'A vibrant gathering of the St. Theresa Kalimoni Parish community, reflecting the unity and joy of faith shared together.' },
  ...
  { id: 'photo-1555883451-aeb2991f0a9e', title: 'Vigil Lights', category: 'Sacraments', desc: 'Every flame represents a prayer, a hope, a life entrusted to God by the faithful of St. Theresa Kalimoni Parish.' },
  ...
  { id: 'photo-1547496613-4e19af6736dc', title: "A Child's Faith", category: 'Youth Activities', desc: 'The future of St. Theresa Kalimoni Parish — young people growing up in the warmth of a living faith community.' },
  ...
  { id: 'photo-1580582932707-520aed937b7b', title: 'YSC Youth Ministry', category: 'Youth Activities', desc: 'The Youths Serving Christ — vibrant, alive, and growing in faith at St. Theresa Kalimoni Parish.' },
  ...
  { id: 'photo-1438032005730-c779502df39b', title: 'Church Interior', category: 'Sacraments', desc: 'The interior of a Catholic church — a place of encounter with the divine that mirrors the spirit of St. Theresa Kalimoni Parish.' },
]
...
export default function Gallery() {
  useSEO({ title: 'Photo Gallery', description: 'Browse photos from St. Theresa Kalimoni Parish — community celebrations, youth ministry, liturgical events, and parish life in Juja, Kenya.', path: '/gallery' })
        ...
        <div className="relative max-w-4xl">
          ...
          <p className="text-sm sm:text-base max-w-lg leading-relaxed" style={{ color: '#F0E8D8AA' }}>
            {live
              ...
              : 'A visual journey through faith and fellowship at St. Theresa Kalimoni Parish.'}
          </p>
        </div>
      </section>
      </div>
